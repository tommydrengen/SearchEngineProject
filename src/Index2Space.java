...
class Index2Space {
    ...
    public Index2Space(String filename) {
        String word;
    ...
    public static void main(String[] args) {
        ...
        // space: https://stackoverflow.com/questions/37916136/how-to-calculate-memory-usage-of-a-java-program
        // space before
        long beforeUsedMem=Runtime.getRuntime().totalMemory()-Runtime.getRuntime().freeMemory();
        Index2Space i = new Index2Space(args[0]);
        // space after
        long afterUsedMem=Runtime.getRuntime().totalMemory()-Runtime.getRuntime().freeMemory();
        long actualMemUsed=afterUsedMem-beforeUsedMem;
        System.out.println("Memory used: " + actualMemUsed/Math.pow(1024, 2) + " MB");
