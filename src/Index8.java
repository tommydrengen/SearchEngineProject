...
class Index8 {
    ...
    public boolean searchPrefix(String searchstr) {
        currentDistinct = startDistinct;
        while (currentDistinct != null) {
            if (currentDistinct.str.startsWith(searchstr)){
                ReturnItem returnItem = ht.get(currentDistinct.str);
                System.out.println("Searchtr: "+ currentDistinct.str);
                System.out.println("Documents from hashtable: ");
                WikiItem currentDoc = returnItem.startDoc;
                while (currentDoc != null){
                    System.out.println("Document: " + currentDoc.str);
                    currentDoc = currentDoc.next;
                }
            }
            currentDistinct = currentDistinct.next;
